...
├── LICENSE                      # MIT 许可证
├── .gitignore
├── setup.ps1                    # 无界面安装脚本（安装器调用）
├── installer-v2.iss             # Inno Setup 脚本（在线安装包）
├── installer-v2-offline.iss     # Inno Setup 脚本（离线安装包）
...
│   ├── create-dsh-shortcut.ps1     # 桌面快捷方式助手（安装后调用）
...
1. 从 Releases 下载 [`Living-Dream-DSH-v2.9.0-Offline-Setup.exe`](https://github.com/alllllllllli/Living-Dream-DSH/releases/download/v2.9.0/Living-Dream-DSH-v2.9.0-Offline-Setup.exe)（约 122 MB）
...
> 💡 还有**在线安装包** [`Living-Dream-DSH-v2.9.0-Setup.exe`](https://github.com/alllllllllli/Living-Dream-DSH/releases/download/v2.9.0/Living-Dream-DSH-v2.9.0-Setup.exe)（约 2 MB），通过 winget 下载依赖。
